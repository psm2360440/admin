                    ...
                    <c:choose>
                        <c:when test="${loginadm == null}">
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="/login" id="btn_login" role="button"
                                 ><span class="mr-2 d-none d-lg-inline text-gray-600 small">LOGIN</span></a>                       </li>
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="/register" id="btn_register" role="button"
                                ><span class="mr-2 d-none d-lg-inline text-gray-600 small">REGISTER</span></a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="/adminfo?id=${loginadm.id}" id="adminfo" role="button"
                                ><span class="mr-2 d-none d-lg-inline text-gray-600 small">${loginadm.id}(${loginadm.lev}번관리자)</span></a>                       </li>
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="/logoutimpl" id="btn_logout" role="button"
                                ><span class="mr-2 d-none d-lg-inline text-gray-600 small">LOGOUT</span></a>
                            </li>
